...
static void settings_button_callback(int32_t ui_list_id, int32_t button_id);
...
void enter_main_menu() {
    ...
    // settings
    ui_list_id = new_ui_list(
        _OUTPORT_WIDTH_*0.5  - (strlen("Settings")*big_letters_font.letter_width + 4*2)*0.5,
        _OUTPORT_HEIGHT_*0.5 + big_letters_font.letter_height*0.5 + 4 - big_letters_font.letter_height*2,
        1,
        &nine_slice2
    );
    ...
    ui_list_add_element(
        ...
        (ui_list_element_t){
            .type = ELEMENT_TYPE_BUTTON,
            .button = {
                .callback = &settings_button_callback,
                .string = "Settings",
                .font = &big_letters_font,
                .padding = 4,
                .nslice = NULL,
