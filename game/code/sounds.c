...
void game_sounds_init() {
    ...
    shield_sound = audio_sound_load("./game/sounds/shield.wav");                // X    // X
    ...
    audio_save_sound_to_c_file(shield_sound, "shield_sound", "./game/sounds/shield_sound.c");
